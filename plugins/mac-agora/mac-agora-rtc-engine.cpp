...
void AgoraEngine::enableExVideo(std::string resolution)
{
    ...
    {
        configuration.dimensions.width = 360;
        configuration.dimensions.height = 640;
        configuration.frameRate = (agora::rtc::FRAME_RATE) 15;
    }
    else if (resolution.find("480") != string::npos)
    {
        configuration.dimensions.width = 480;
        configuration.dimensions.height = 840;
        configuration.frameRate = (agora::rtc::FRAME_RATE) 24;
    }
    else if (resolution.find("720") != string::npos)
    {
        configuration.dimensions.width = 720;
        configuration.dimensions.height = 1280;
        configuration.frameRate = (agora::rtc::FRAME_RATE) 24;
        configuration.bitrate = 4160;
        configuration.minBitrate = 1130;
    }
    else if (resolution.find("1080") != string::npos)
    {
        configuration.dimensions.width = 1080;
        configuration.dimensions.height = 1920;
        configuration.frameRate = (agora::rtc::FRAME_RATE) 30;
        configuration.bitrate = 4160;
        configuration.minBitrate = 2080;
    }
